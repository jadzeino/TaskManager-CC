...
import { clearTestDatabase } from '../db/database';
...
describe.only('Integration tests', () => {
  ...
  test('should update task status', async () => {
    ...
    const response = await request.put(`/tasks/${createdTaskId}/status`).send(updateData);
  ...
  test('should assign the created task to the new user', async () => {
    ...
    const response = await request.put(`/tasks/${createdTaskId}/assign/${newUserId}`).send(assignData);
  ...
  test('should get task history for task assignment', async () => {
    ...
    const assignedTaskhistory = response.body.find((task:any)=>task.field==="assignedTo")
